...
class JoitsBootstrap extends CollectionBasedBootstrap {
	...
	override run() {
		...
		val repoRodajes = new RepoRodajes => [
			...
			create(new Rodaje(1972, "The Godfather", 9.2f, "Crime, Drama"))
			create(new Rodaje(1974, "The Godfather: Part II", 9.0f, "Crime, Drama"))
			create(new Rodaje(1999, "Fight Club", 8.8f, "Drama"))
			create(new Rodaje(1994, "Forrest Gump", 8.8f, "Drama, Romance"))
			create(new Rodaje(2010, "Inception", 8.8f, "Action, Adventure, Sci-Fi"))
			create(new Rodaje(1999, "Matrix", 8.7f, "Action, Sci-Fi "))
			create(new Rodaje(2014, "Interstellar", 8.6f, "Adventure, Drama, Sci-Fi"))
			create(new Rodaje(2019, "Captain Marvel", 7.1f, "Action, Adventure, Sci-Fi"))
			create(
